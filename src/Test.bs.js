...
function testDealCascades(param) {
  ...
  return /* :: */[
          TestLib.assertEqual(undefined, 52, List.length(allCards), "52 cards should be dealt"),
          /* :: */[
            TestLib.assertEqual(undefined, true, Belt_List.every(cardsPerSuit, (function (cards) {
